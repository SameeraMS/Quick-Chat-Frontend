    ...
    useEffect(() => {
        ...
        const fetchChannels = async () => {
            try {
                ...
                setChannels(result.channels || []); // Default to empty array if result.channels is undefined
                setLastMessages(result.lastMessages || []); // Default to empty array if result.lastMessages is undefined
            } catch (error) {
            ...
            <div className='overflow-x-hidden overflow-y-auto max-h-[865px] pb-16'>
                {
                    isPending
                        ...
                        :
                        (
                            channels?.length > 0 // Add null/undefined check
                                ?
